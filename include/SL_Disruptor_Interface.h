...
public:
    ...
    virtual int     init(uint capacity, uint event_len, int rewrite_count, int reread_count) = 0;
    virtual void    clear() = 0;

    virtual int64   push(const SL_Disruptor_Event *event, int redo_count) = 0;
