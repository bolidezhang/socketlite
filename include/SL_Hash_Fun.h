...
//2的N次方列表
#define SL_NUM_2_POW        32
#define SL_DEFAULT_2_POW    32
const ulong SL_2_POW_LIST[SL_NUM_2_POW] = { 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 
    2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576, 
    2097152, 4194304, 8388608, 16777216, 33554432, 67108864, 134217728, 
    268435456, 536870912, 1073741824, 2147483648 };

//常用质数(或称素数)列表
#define SL_NUM_PRIMES 28
const ulong SL_PRIME_LIST[SL_NUM_PRIMES] = { 53, 97, 193, 389, 769, 1543, 3079, 6151, 
