...
public:
    ...
    //内存比较
    static inline int memcmp(void *s1, void *s2, size_t n)
    {
        return std::memcmp(s1, s2, n);
    }

    static inline void memmove(void *dest, void *src, size_t n)
    {
